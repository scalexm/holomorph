...
impl_type!(JobCrafterDirectoryEntryRequestMessage, 6043, player_id| VarLong);
...
impl_type!(JobCrafterDirectoryRemoveMessage, 5653, job_id| i8, player_id| VarLong);
...
impl_type!(JobExperienceOtherPlayerUpdateMessage, 6599, base| JobExperienceUpdateMessage, player_id| VarLong);
...
impl_type!(JobMultiCraftAvailableSkillsMessage, 5747, base| JobAllowMultiCraftRequestMessage, player_id| VarLong, skills| Vec<VarShort>);
