...
impl_type!(AbstractFightDispellableEffect, 206, uid| VarInt, target_id| f64, turn_duration| i16, dispelable| i8, spell_id| VarShort, effect_id| VarInt, parent_boost_uid| VarInt);
...
impl_type!(GameActionMark, 351, mark_author_id| f64, mark_team_id| i8, mark_spell_id| i32, mark_spell_level| i8, mark_id| i16, mark_type| i8, markimpact_cell| i16, cells| Vec<GameActionMarkedCell>, active| bool);
