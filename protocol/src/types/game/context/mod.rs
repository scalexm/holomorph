...
impl_type!(ActorOrientation, 353, id| f64, direction| i8);
...
impl_type!(FightEntityDispositionInformations, 217, base| EntityDispositionInformations, carrying_character_id| f64);
impl_type!(GameContextActorInformations, 150, contextual_id| f64, look| EntityLook, disposition| EntityDispositionInformationsVariant);
...
impl_type!(IdentifiedEntityDispositionInformations, 107, base| EntityDispositionInformations, id| f64);
