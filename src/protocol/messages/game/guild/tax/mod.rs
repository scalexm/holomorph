...
use std::io::Result;
use protocol::*;
use variants::TaxCollectorInformationsVariant;  use types::game::guild::tax::TaxCollectorBasicInformations; use types::game::guild::tax::TaxCollectorMovement; use types::game::context::roleplay::BasicGuildInformations; use types::game::character::CharacterMinimalPlusLookInformations; use types::game::guild::tax::TaxCollectorFightersInformation;
...
impl_type!(GuildFightLeaveRequestMessage, 5715, tax_collector_id| i32, character_id| VarLong);
impl_type!(GuildFightPlayersEnemiesListMessage, 5928, fight_id| i32, player_info| Vec<CharacterMinimalPlusLookInformations>);
impl_type!(GuildFightPlayersEnemyRemoveMessage, 5929, fight_id| i32, player_id| VarLong);
impl_type!(GuildFightPlayersHelpersJoinMessage, 5720, fight_id| i32, player_info| CharacterMinimalPlusLookInformations);
impl_type!(GuildFightPlayersHelpersLeaveMessage, 5719, fight_id| i32, player_id| VarLong);
...
impl_type!(TaxCollectorMovementMessage, 5633, movement_type| i8, basic_infos| TaxCollectorBasicInformations, player_id| VarLong, player_name| String);
impl_type!(TaxCollectorMovementRemoveMessage, 5915, collector_id| i32);
impl_type!(TaxCollectorMovementsOfflineMessage, 6611, movements| Vec<TaxCollectorMovement>);
