...
impl_type!(ChatSmileyMessage, 801, entity_id| f64, smiley_id| VarShort, account_id| i32);
...
impl_type!(MoodSmileyUpdateMessage, 6388, account_id| i32, player_id| VarLong, smiley_id| VarShort);
