...
impl_type!(EmotePlayMassiveMessage, 5691, base| EmotePlayAbstractMessage, actor_ids| Vec<f64>);
impl_type!(EmotePlayMessage, 5683, base| EmotePlayAbstractMessage, actor_id| f64, account_id| i32);
