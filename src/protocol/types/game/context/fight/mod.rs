...
impl_type!(AbstractFightTeamInformations, 116, team_id| i8, leader_id| f64, team_side| i8, team_type_id| i8, nb_waves| i8);
...
impl_type!(FightTeamMemberInformations, 44, id| f64);
...
impl_type!(GameFightCompanionInformations, 450, base| GameFightFighterInformations, companion_generic_id| i8, level| i8, master_id| f64);
...
impl_type!(GameFightFighterLightInformations, 413, sex| Flag, alive| Flag, id| f64, wave| i8, level| VarShort, breed| i8);
...
impl_type!(GameFightResumeSlaveInfo, 364, slave_id| f64, spell_cooldowns| Vec<GameFightSpellCooldown>, summon_count| i8, bomb_count| i8);
