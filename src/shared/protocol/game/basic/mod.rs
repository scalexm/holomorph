...
use io::Result;
use protocol::*;
 use protocol::game::social::AbstractSocialGroupInfosVariant;
...
impl_type!(BasicWhoIsMessage, 180, self| Flag, verbose| Flag, position| i8, account_nickname| String, account_id| i32, player_name| String, player_id| VarInt, area_id| i16, social_groups| Vec<AbstractSocialGroupInfosVariant>, player_state| i8);
...
impl_type!(NumericWhoIsMessage, 6297, player_id| VarInt, account_id| i32);
impl_type!(NumericWhoIsRequestMessage, 6298, player_id| VarInt);
