...
use io::Result;
use protocol::*;
use protocol::game::data::items::ObjectItemGenericQuantity; use protocol::game::data::items::ObjectItemToSellInHumanVendorShop;  use protocol::game::data::items::ObjectItemNotInContainer; use protocol::game::mount::MountClientData; use protocol::game::data::items::ObjectItem; use protocol::game::data::items::ObjectItemToSell; use protocol::game::data::items::BidExchangerObjectInfo; use protocol::game::mount::UpdateMountBoostVariant; use protocol::game::data::items::effects::ObjectEffectVariant; use protocol::game::data::items::ObjectItemToSellInNpcShop; use protocol::game::data::items::ObjectItemToSellInBid; use protocol::game::context::roleplay::job::DecraftedItemStackInfo; use protocol::game::data::items::SellerBuyerDescriptor;
...
impl_type!(ExchangeBidHouseInListAddedMessage, 5949, item_u_i_d| i32, obj_generic_id| i32, effects| Vec<ObjectEffectVariant>, prices| Vec<VarInt>);
impl_type!(ExchangeBidHouseInListRemovedMessage, 5950, item_u_i_d| i32);
...
impl_type!(ExchangeBidHouseSearchMessage, 5806, ttype| VarInt, gen_id| VarShort);
impl_type!(ExchangeBidHouseTypeMessage, 5803, ttype| VarInt);
...
impl_type!(ExchangeItemAutoCraftRemainingMessage, 6015, count| VarInt);
...
impl_type!(ExchangeObjectMoveMessage, 5518, object_u_i_d| VarInt, quantity| VarInt);
...
impl_type!(ExchangeObjectUseInWorkshopMessage, 6004, object_u_i_d| VarInt, quantity| VarInt);
...
impl_type!(ExchangeReplayCountModifiedMessage, 6023, count| VarInt);
impl_type!(ExchangeReplayMessage, 6002, count| VarInt);
...
impl_type!(ExchangeSetCraftRecipeMessage, 6389, object_g_i_d| VarShort);
