...
use io::Result;
use protocol::*;
use protocol::types::game::character::alignment::ActorAlignmentInformations;  use protocol::variants::FightResultAdditionalDataVariant; use protocol::types::game::context::GameContextActorInformations; use protocol::types::game::context::roleplay::BasicGuildInformations; use protocol::variants::FightTeamMemberInformationsVariant; use protocol::types::game::context::roleplay::BasicAllianceInformations; use protocol::variants::GameFightMinimalStatsVariant; use protocol::variants::FightTeamInformationsVariant; use protocol::types::game::character::status::PlayerStatus;
