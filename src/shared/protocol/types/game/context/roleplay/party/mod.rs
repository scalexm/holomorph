...
use io::Result;
use protocol::*;
 use protocol::types::game::context::roleplay::party::companion::PartyCompanionMemberInformations; use protocol::types::game::context::roleplay::party::companion::PartyCompanionBaseInformations; use protocol::types::game::look::EntityLook; use protocol::variants::PlayerStatusVariant; use protocol::types::game::character::choice::CharacterBaseInformations;
