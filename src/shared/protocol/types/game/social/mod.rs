...
use io::Result;
use protocol::*;
 use protocol::types::game::context::roleplay::GuildInformations; use protocol::types::game::context::roleplay::AllianceInformations; use protocol::types::game::context::roleplay::BasicNamedAllianceInformations;
