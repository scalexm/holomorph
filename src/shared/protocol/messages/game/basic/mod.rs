...
use io::Result;
use protocol::*;
 use protocol::variants::AbstractSocialGroupInfosVariant;
...
impl_type!(BasicWhoIsMessage, 180, self_| Flag, verbose| Flag, position| i8, account_nickname| String, account_id| i32, player_name| String, player_id| VarInt, area_id| i16, social_groups| Vec<AbstractSocialGroupInfosVariant>, player_state| i8);
