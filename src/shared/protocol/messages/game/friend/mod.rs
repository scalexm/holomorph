...
use io::Result;
use protocol::*;
 use protocol::variants::FriendInformationsVariant; use protocol::variants::IgnoredInformationsVariant; use protocol::variants::FriendSpouseInformationsVariant;
